...
class LightGCN(GeneralRecommender):
    ...
    def get_knn_adj_mat(self, v_embeddings, t_embeddings, config):
        ...
        mm_adj = text_adj * self.mm_image_weight[0] + image_adj * self.mm_image_weight[1] + session_adj * self.mm_image_weight[2]

        return mm_adj, v_sim, t_sim
    ...
    def forward(self):
        ...
        for i in range(self.n_layers):
            h_m = torch.sparse.mm(self.mm_adj.cuda(), h_m)
